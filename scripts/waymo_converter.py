...
if __name__ == '__main__':
    ...
    for i, split in enumerate(splits):
        load_dir = osp.join(args.root_path, 'waymo_format', split)
        if split == 'validation':
            save_dir = osp.join(args.out_dir, 'kitti_format', 'training')
        else:
            save_dir = osp.join(args.out_dir, 'kitti_format', split)
