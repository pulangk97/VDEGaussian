...
from adapter import LoRALinearLayer, freeze_original_parameters
...
if __name__ == "__main__":
    ...
    freeze_original_parameters(model,adapter=LoRALinearLayer)
    model._init_img_ctx_projector(model.image_proj_stage_config, trainable=True)
    ...
    if args.train:
        try:
            if "strategy" in lightning_config and lightning_config['strategy'].startswith('deepspeed'):
                ...
                ## deepspeed
                # print(trainer_kwargs['precision'] )
